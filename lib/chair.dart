        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              //height: 100,
              child: Text(
                "Upholestry: Cotton, Filling Material: Cotton,W X H X D : 177.8 cm x 81.28 cm x 72.39 cm.It Has An Elegant Design Which Enhances The Interior Decor Of Your Living Room.It Is Made Of Solid Wood",
            ...
            Expanded(
              child: ListView(
                  ...
                  children: [
                    ...
                    Container(
                      //color: Colors.blue,
                      child: Image.asset('assets/setti(1).jpeg'),
                    ),
                    //SizedBox(width: 5),
                    Container(
                      //color: Colors.green,
                      child: Image.asset('assets/setti(2).jpeg'),
                    ),
                    //SizedBox(width: 5),
                    Container(
                      //color: Colors.yellow,
                      child: Image.asset('assets/setti(3).jpeg'),
                    ),
                    //SizedBox(width: 5),
